...
public class Crossover {
	...
	public static void crossoverGuided(int[][] matrixPhen) {
		int maxFitness = 0, difference = 0, mAXdifference = 0, indexRow1, indexMaxDifference = 0;
		int differenceIJ = 0, equation = 0, equationBest = 0, jindexMaxEquation = 0, fitnessRow1 = 0;
